...
var z = { BASE_URL: "/", MODE: "production", DEV: !1, PROD: !0, SSR: !1, REACT_APP_CONNECT_VERSION: "0.3.21" };
const q = (e) => typeof e == "object" && e !== null, A = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakSet(), he = (e = Object.is, t = (n, h) => new Proxy(n, h), s = (n) => q(n) && !x.has(n) && (Array.isArray(n) || !(Symbol.iterator in n)) && !(n instanceof WeakMap) && !(n instanceof WeakSet) && !(n instanceof Error) && !(n instanceof Number) && !(n instanceof Date) && !(n instanceof String) && !(n instanceof RegExp) && !(n instanceof ArrayBuffer), r = (n) => {
...
}, m = /* @__PURE__ */ new WeakMap(), f = [1, 1], W = (n) => {
  if (!q(n))
  ...
  let P = f[1];
  const L = (i = ++f[1]) => (P !== i && !y.size && (P = i, b.forEach(([a]) => {
    const o = a[1](i);
    o > I && (I = o);
  })), I), M = (i) => (a, o) => {
    const g = [...a];
...
} }, O = j({ chains: void 0, walletConnectUri: void 0, isAuth: !1, isCustomDesktop: !1, isCustomMobile: !1, isDataLoaded: !1, isUiLoaded: !1 }), w = { state: O, subscribe(e) {
  return D(O, () => e(O));
}, setChains(e) {
  O.chains = e;
...
var Ie = Object.defineProperty, se = Object.getOwnPropertySymbols, Oe = Object.prototype.hasOwnProperty, Ee = Object.prototype.propertyIsEnumerable, ne = (e, t, s) => t in e ? Ie(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : e[t] = s, Le = (e, t) => {
  for (var s in t || (t = {}))
...
async function K(e, t) {
  const s = Le({ sdkType: X, sdkVersion: Y }, t), r = new URL(e, Q);
...
var We = Object.defineProperty, oe = Object.getOwnPropertySymbols, Ce = Object.prototype.hasOwnProperty, Ae = Object.prototype.propertyIsEnumerable, re = (e, t, s) => t in e ? We(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : e[t] = s, je = (e, t) => {
  for (var s in t || (t = {}))
...
const ae = p.isMobile(), E = j({ wallets: { listings: [], total: 0, page: 1 }, search: { listings: [], total: 0, page: 1 }, recomendedWallets: [] }), _e = { state: E, async getRecomendedWallets() {
  ...
  const t = je({}, e), { explorerRecommendedWalletIds: s, explorerExcludedWalletIds: r } = _.state, { recomendedWallets: l } = E;
  if (r === "ALL")
    return E.wallets;
  ...
  const { page: c, search: m } = e, { listings: f, total: W } = ae ? await U.getMobileListings(t) : await U.getDesktopListings(t), n = Object.values(f), h = m ? "search" : "wallets";
  return E[h] = { listings: [...E[h].listings, ...n], total: W, page: c ?? 1 }, { listings: n, total: W };
}, getWalletImageUrl(e) {
...
class ke {
  ...
  async initUi() {
    if (typeof window < "u") {
      await import("./index-C8GxuZZ-.mjs");
