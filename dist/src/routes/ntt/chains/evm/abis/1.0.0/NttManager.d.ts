...
export declare namespace TransceiverRegistry {
    ...
    type TransceiverInfoStructOutput = [boolean, boolean, number] & {
        registered: boolean;
        enabled: boolean;
        index: number;
    };
...
export interface NttManager extends BaseContract {
    ...
    functions: {
        ...
        getTransceiverInfo(overrides?: CallOverrides): Promise<[TransceiverRegistry.TransceiverInfoStructOutput[]]>;
    ...
    populateTransaction: {
        ...
        getTransceiverInfo(overrides?: CallOverrides): Promise<PopulatedTransaction>;
